    ...
    <style>
        ...
        *{ margin:0; padding: 0; }
        ...
        .startScreen {
            ...
            margin-left: 25%;
            top: 350px;
            background-color: rgb(42, 39, 100);
            border-radius: 5px;
            font-size: 18px;
            border:3px solid #3020d7;
            color: #526093;
            z-index: 4;
            text-align: center;
            padding-top: 10px;
...
<body>
    ...
    <?php if (isset($user)): ?>
        ...
        ">Hello <?= htmlspecialchars($user["name"]) ?></p>
    
        <p class="new_set2" style="position: absolute;
           top: 2%;
           left: 92%;
           "><a href="logout.php"
            style="
    ...
    <div class="game" style="overflow: hidden;">
        ...
        <div class="startScreen">
            <span style="color:rgb(81, 93, 183);"><span style="color:#ffffff;"></span>
            <br> <span style='font-size:30px;color:#57c0b7;'>Lets play a game </span>
    ...
    /* box-shadow: 8px 8px 16px #d1d9e6, -8px -8px 16px #f9f9f9; */
    border: none;
    outline: none;" >PLAY AGAIN</button>
              </a>
            </span></div>
        <div class="gameArea">
        </div>
    ...
    <script type="text/javascript">
        ...
        function playGame() {
            ...
            if (player.start ) {
                ...
                let checkscore = Number(localStorage.score);
        ...
        function endGame() {
        	...
        	player.shown = 0;
        	let cookiescore = Number(localStorage.score);
